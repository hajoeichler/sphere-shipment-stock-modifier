/* ===========================================================
# sphere-shipment-stock-modifier - v0.0.2
# ==============================================================
# Copyright (c) 2013 Hajo Eichler
# Licensed under the MIT license.
*/
var ProgressBar, Q, Rest, ShipmentStockModifier, logentries, _;
...
ShipmentStockModifier = (function() {
  ...
  ShipmentStockModifier.prototype.modifyOrder = function(order) {
    ...
    this.getState(order).then(function(state) {
      ...
      return _this.saveState(order, mod).then(function(msg) {
        var action, posts, result, _i, _len, _ref;
  ...
  ShipmentStockModifier.prototype.returnResult = function(positiveFeedback, msg, callback) {
    var d, logLevel;
